...
#else
 extern col_type_t klapse_red;
 extern col_type_t klapse_green;
 extern col_type_t klapse_blue;

 extern void sprd_dpu_klapse_set_rgb(int r, int g, int b);
extern void sprd_dpu_klapse_uninit(void);
#endif
