...
col_type_t klapse_red = MAX_SCALE;
col_type_t klapse_green = MAX_SCALE;
col_type_t klapse_blue = MAX_SCALE;
...
{
	current_r = klapse_red * 100 / dimmer;
        current_g = klapse_green * 100 / dimmer;
        current_b = klapse_blue * 100 / dimmer;
}
